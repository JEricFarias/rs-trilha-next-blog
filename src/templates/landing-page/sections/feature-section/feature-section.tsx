...
export function FeatureSection() {
  return (
    <section className="container bg-gray-700 grid gap-6 md:grid-cols-2 pt-10 pb-[72px] md:pt-20 md:pb-32">
      <div className="flex flex-col gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
        ...
        <h2 className="text-gray-100 text-heading-sm md:text-heading-lg font-ptsans">
